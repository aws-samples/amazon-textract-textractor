...
requirements = [
    'boto3', 'botocore', 'amazon-textract-response-parser', 'amazon-textract-caller>=0.0.2',
    'amazon-textract-overlayer', 'amazon-textract-prettyprinter', 'Pillow==8.1.2', 'PyPDF2==1.26.0'
]
